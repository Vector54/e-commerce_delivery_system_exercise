...
RSpec.describe UpdateLine, type: :model do
  describe '#valid?' do
    it 'coordinates presence true' do
      ...
      ul = UpdateLine.new(coordinates: '87.98465, 8.65498', order: os)

      expect(ul.valid?).to be true
    end
    ...
    it 'coordinates presence false' do
      ...
      ul = UpdateLine.new(coordinates: '', order: os)

      expect(ul.valid?).to be false
    end
    ...
    it 'coordinates format invalid' do
      ...
      ul = UpdateLine.new(coordinates: '64684 545', order: os)
